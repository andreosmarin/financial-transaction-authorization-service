...
flowchart LR
    ...
    Consumer --> UseCases
    UseCases --> Domain["Domínio Account / Transaction / Money"]
...
| `Money` + `NUMERIC(19,2)`/`BigDecimal` | centralizar moeda, escala e aritmética decimal determinística | escala 2 e arredondamento proibido; moedas com outra quantidade de minor units exigem evolução do schema/value object |
